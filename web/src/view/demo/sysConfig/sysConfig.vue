  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
          ...
          <el-table-column align="left" label="主键编码" prop="id" width="120" />
          <el-table-column align="left" label="ConfigName" prop="configName" width="120" />
          <el-table-column align="left" label="ConfigKey" prop="configKey" width="120" />
          <el-table-column align="left" label="ConfigValue" prop="configValue" width="120" />
          <el-table-column align="left" label="ConfigType" prop="configType" width="120" />
          <el-table-column align="left" label="是否前台" prop="isFrontend" width="120" />
          <el-table-column align="left" label="Remark" prop="remark" width="120" />
          <el-table-column align="left" label="创建者" prop="createBy" width="120" />
          <el-table-column align="left" label="更新者" prop="updateBy" width="120" />
         <el-table-column align="left" label="创建时间" prop="createdAt" width="180">
            <template #default="scope">{{ formatDate(scope.row.createdAt) }}</template>
         </el-table-column>
         <el-table-column align="left" label="最后更新时间" prop="updatedAt" width="180">
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="主键编码:"  prop="id" >
              <el-input v-model.number="formData.id" :clearable="true" placeholder="请输入主键编码" />
            </el-form-item>
            ...
            <el-form-item label="创建者:"  prop="createBy" >
              <el-input v-model.number="formData.createBy" :clearable="true" placeholder="请输入创建者" />
            </el-form-item>
            <el-form-item label="更新者:"  prop="updateBy" >
              <el-input v-model.number="formData.updateBy" :clearable="true" placeholder="请输入更新者" />
            </el-form-item>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="主键编码">
                        {{ detailFrom.id }}
                    </el-descriptions-item>
                    <el-descriptions-item label="ConfigName">
                        {{ detailFrom.configName }}
                    </el-descriptions-item>
                    <el-descriptions-item label="ConfigKey">
                        {{ detailFrom.configKey }}
                    </el-descriptions-item>
                    <el-descriptions-item label="ConfigValue">
                        {{ detailFrom.configValue }}
                    </el-descriptions-item>
                    <el-descriptions-item label="ConfigType">
                        {{ detailFrom.configType }}
                    </el-descriptions-item>
                    <el-descriptions-item label="是否前台">
                        {{ detailFrom.isFrontend }}
                    </el-descriptions-item>
